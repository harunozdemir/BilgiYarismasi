...
namespace bilg_oyun
{
    public partial class frmSpor : Form
    {
        ...
        public void Sorusor(int SoruNo)
        {
            ...
            cmd.CommandText = "SELECT * FROM Spor WHERE soruNo =" + SoruNo;
        ...
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            String selectText = "SELECT dogruCevap FROM Spor WHERE soruNo=" + Soruno;
        ...
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            String selectText = "SELECT count(*) FROM Spor";
        ...
        public void cevapKontrol(string cevap)
        {
            ...
            lblPuanSpor.Text = netSayisi.ToString();
        ...
        private void pbIleri_Click(object sender, EventArgs e)
        {
            if (sorulacakSoru <= soruSayisi())
            {
                ...
                if (sorulacakSoru == soruSayisi() + 1)
                    MessageBox.Show("Yarışma sona erdi.Puanınız: " + lblPuanSpor.Text.ToString(), "Tebrikler",
        ...
        private void frmSpor_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void update_istatistik()
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            OleDbConnection con = new OleDbConnection(conStr);
            string selectText = "UPDATE İstatistikler SET spor_dogru_sayisi=spor_dogru_sayisi+@dogru,spor_yanlis_sayisi=spor_yanlis_sayisi+@yanlis";
