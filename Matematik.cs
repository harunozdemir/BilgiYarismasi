...
namespace bilg_oyun
{
    public partial class Matematik : Form
    {
        ...
        public void Sorusor(int SoruNo)
        {
            ...
            cmd.CommandText = "SELECT * FROM Matematik WHERE soruNo =" + SoruNo;
        ...
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            String selectText = "SELECT dogruCevap FROM Matematik WHERE soruNo=" + Soruno;
        ...
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            String selectText = "SELECT count(*) FROM Matematik";
        ...
        public void cevapKontrol(string cevap)
        {
            ...
            lblPuanMatematik.Text = netSayisi.ToString();
        ...
        private void pbIleri_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Yarışma sona erdi.Puanınız: " + lblPuanMatematik.Text.ToString(), "Tebrikler", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void Matematik_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void update_istatistik()
        {
            String conStr = "Provider=Microsoft.ACE.Oledb.12.0;Data Source=bilgi_yarismasi.accdb";
            OleDbConnection con = new OleDbConnection(conStr);
            string selectText = "UPDATE İstatistikler SET mat_dogru_sayisi=mat_dogru_sayisi+@dogru,mat_yanlis_sayisi=mat_yanlis_sayisi+@yanlis";
        ...
        private void pbIleri_Click_1(object sender, EventArgs e)
        {
            if (sorulacakSoru <= soruSayisi())
            {
                ...
                Sorusor(sorulacakSoru);
                if (sorulacakSoru == soruSayisi() + 1)
                    MessageBox.Show("Yarışma sona erdi.Puanınız: " + lblPuanMatematik.Text.ToString(), "Tebrikler",
